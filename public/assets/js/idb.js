...
function saveRecord(record) {
    // open a new transaction (or a temporary connection) with the database with read and write permissions into the new_pizza object store we declared earlier
